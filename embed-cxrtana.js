...
module.exports = {
    name: 'embed-cxtana',
    description: 'embed-cxrtana',
    options: [],

    run: async (client, int) =>{  
        ('Este es un mensaje fuera del embed')      
        const Embed1 = new Discord.EmbedBuilder()
            .setTitle('¡Hola!, SOY EL BOT DE REGLAS')
           // .setThumbnail(('https://cdn.discordapp.com/avatars/833443168321798164/a_fb9221751e9b439227dfa6efffc6c092.gif?size=512'))//logo en pequeño
            .setColor('#000033')
